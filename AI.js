...
but try not to include too many extra ingredients. Format your response in 
markdown to make it easier to render to a web page
`

const hf = new HfInference(import.meta.env.VITE_HF_CHEF_API_KEY)
    ...
    const response = await hf.chatCompletion (
      {
        ...
        messages: [
          ...
          {role: "user", content: `I have ${ingredientString}. Plesae give me a recipe
